...
function bai5() {
    // B2: Lấy input đầu vào
    // Tạo biến nhapN gán giá trị số nhập từ bàn phím
    var nhapN = +dom("nhapN").value;
    // B4: Tạo biến ketQua gán giá trị là 1 chuỗi rỗng
    var ketQua = "";
    // B4: Tạo vòng lặp for xử lý in số nguyên tố từ 1 -> nhapN 
    for(i = 1; i <= nhapN; i++) {
